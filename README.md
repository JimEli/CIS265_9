...
* Store each word in a dynamically allocated string, using an array of pointers to keep track of the strings, as in the remind2.c program (Section 17.2). 
* After all words have been read, sort the array (using any sorting techniques) and then use a loop to print the words in sorted order. 
